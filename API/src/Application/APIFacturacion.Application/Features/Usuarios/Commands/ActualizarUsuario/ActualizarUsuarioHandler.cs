...
namespace APIFacturacion.Application.Features.Usuarios.Commands.ActualizarUsuario
{
    public class ActualizarUsuarioHandler : IRequestHandler<ActualizarUsuarioCommand, Respuesta<int>>
    {
        ...
        public ActualizarUsuarioHandler(IUnitOfWork unitOfWork, IMapper mapper, APIFacturacion.Encryption.IPasswordHasher passwordHasher)
        {
        ...
        public async Task<Respuesta<int>> Handle(ActualizarUsuarioCommand request, CancellationToken cancellationToken)
        {
            ...
            // Si la clave viene vacÃ­a, no se actualiza (se mantiene la anterior)
